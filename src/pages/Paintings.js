...
function Paintings() {
  return (
    ...
    <div>
      ...
      <img src="images/peinture_1.jpg" alt="Painting 1" class="art-image" />
      ...
      <div className="art-item">
      <img src="images/peinture_2.jpg" alt="Painting 2" class="art-image" />
      <div className="art-description">
      <h3>Echo des silences</h3>
      ...
      <div className="art-item">
      <img src="images/peinture_3.jpg" alt="Painting 3" class="art-image" />
      <div className="art-description">
      <h3>Echo des silences</h3>
